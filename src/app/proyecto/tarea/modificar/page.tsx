        ...
        await saveTarea(proyectoId, tarea)
            .then((res) => {
                if (res && !res.httpOk) {
                    ...
                    setTimeout(() => {
                        router.push(`/proyecto/tarea/detalle?proyectoId=${proyectoId}&tareaId=${tareaId}`); // NAVEGAR A DETALLE DE TAREA ¿?¿?
                    }, 1500);
                }
            })
        setLoading(false); // Indicamos que la carga ha terminado, independientemente del resultado
    ...
    return (
        <>
            {loading ? (
                ...
                <>
                    <h4 className="text-3xl font-bold ms-4">Modificar Tarea</h4>
                    ...
                    <div className='m-4 grid grid-cols-2 gap-4'>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="date"
                                className="border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"
                                value={tarea.fechaInicio ? tarea.fechaInicio : undefined}
                            />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                type="date"
                                className="border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500"
                                value={tarea.fechaFin ? tarea.fechaFin : undefined}
                            />
